...
իրենց _նախապատվությունների_ (precedence)
...
Հավասարության և համեմատման գործողությունները ասոցեատիվություն չունեն։ Աստիճան 
բարձրացնելու `^` գործողությունը աջ ասոցեատիվ է, իսկ մյուս բոլոր գործողությունները՝ 
ձախ ասոցեատիվ։ Բացի բացասման `-` և ժխտման `NOT` միտեղանի (ունար) 
գործողություններից մյուս բոլոր գործողությունները երկտեղանի (բինար) են և աջ 
ասոցեատիվ։
